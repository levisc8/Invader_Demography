...
Ailanthus4R$Treatment <- gsub("Competitor Removal",
                              "Comp",
                              Ailanthus4R$Treatment)

### Infile germination data ###
Ailanthus4R_Germ <- read.csv("Ailanthus_IPM/Ailanthus_Germ.csv")
head(Ailanthus4R_Germ)

### Infile seedling count data ###
AASeedlings <- read.csv("Ailanthus_IPM/Ailanthus_Seedlings.csv", header = TRUE)
...
Good_PopData <- PopData1#[PopData$Quality2013 =='good',]
...
Clones <- Clones2[Clones2$Stage == 'gone' & Clones2$Quality2013 == 'good',]

PopDataRA1 <- PopData[PopData$StageNext != 'RA',] 
PopDataRA <- PopDataRA1[PopDataRA1$StageNext != 'Boy',]
PopDataSeeds <- Ailanthus4R[Ailanthus4R$StageNext == 'RA' | Ailanthus4R$StageNext == 'girl',]
